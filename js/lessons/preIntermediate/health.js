 ...
 dialogue: {
    ...
    microChecks: {
        ...
        items: [
            ...
            },
            {
                id: "health_mc3",
                type: "reorder",
                prompt: "Reorder: I need medicine.",
                options: ["بَحْتَاج", "دَوَا"],
                correct: ["بَحْتَاج", "دَوَا"],
            },
            {
                id: "health_mc4",
                type: "complete",
                prompt: "Complete the Arabic for: symptoms. ___",
                options: ["أَعْرَاض", "السُّوق", "الشُّوب", "المَقَاس"],
                correct: "أَعْرَاض",
            },
            {
                id: "health_mc5",
    ...
    practice: {
        quiz: [
            ...
            {
                id: "health_q6",
                questionAr: "إِذَا مَا بَتِقْدَر تِتْنَفَّس مْنِيح، هَادَا:",
                optionsEn: ["serious/emergency phrase", "normal shopping phrase", "weather small talk"],
                correctIndex: 0,
            },
            {
                id: "health_q7",
                questionAr: "«حَبَّة مَرَّتَيْن فِي اليَوم» مُمْكِن نِسْمَعْهَا مَع:",
                optionsEn: ["medicine instructions", "family names", "colors"],
                correctIndex: 0,
            },
            {
                id: "health_q8",
                questionAr: "«عِنْدِي حَسَاسِيَّة» مَعْنَاهَا:",
                optionsEn: ["I have an allergy.", "I have a discount.", "I have a brother."],
                correctIndex: 0,
            },
            {
                id: "health_q9",
                questionAr: "إِذَا الحَالَة خَطِيرَة، بِنِقُول:",
                optionsEn: ["اِتَّصِل بِالإِسْعَاف.", "آخِر سِعِر؟", "كِيف الجَوّ؟"],
                correctIndex: 0,
            },
        ],
        rolePlays: [
            "A friend looks sick before class. Ask what is wrong, offer water, and suggest going to the clinic.",
            "At the clinic: describe headache, fever, cough, and when the symptoms started.",
            "At the pharmacy: ask for medicine for cough and headache, and ask when to take it.",
            "Emergency mini-role-play: someone cannot breathe well. Say clear short sentences and call for help.",
            "Mini speaking prompt: describe a day you were sick and what you did.",
        ],
        translation: [
